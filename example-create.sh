...
oc process -f fluentd.yaml -v MASTER_URL=https://master.dev.example.com:8443 | oc create -f -
oc process -f kibana.yaml -v OAP_MASTER_URL=https://master.dev.example.com:8443,OAP_DEBUG=true | oc create -f -
